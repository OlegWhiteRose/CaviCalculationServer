...
func StartServer() {
	...
	api := r.Group("/api")
	{
		...
		api.POST("/cavi-groups", authMiddleware.RequireAuth(), authMiddleware.RequireDoctor(), h.CreateGroupAPI)
		api.PUT("/cavi-groups/:id", authMiddleware.RequireAuth(), authMiddleware.RequireDoctor(), h.UpdateGroupAPI)
		api.DELETE("/cavi-groups/:id", authMiddleware.RequireAuth(), authMiddleware.RequireDoctor(), h.DeleteGroupAPI)
		api.POST("/cavi-groups/:id/image", authMiddleware.RequireAuth(), authMiddleware.RequireDoctor(), h.UploadGroupImageAPI)
		...
		api.PUT("/cavi-calculations/:id/moderate", authMiddleware.RequireAuth(), authMiddleware.RequireDoctor(), h.ModerateCalculationAPI)
